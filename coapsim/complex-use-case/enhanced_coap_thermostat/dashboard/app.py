...
# --- Configuration ---
SECRET_KEY = os.getenv('FLASK_SECRET_KEY', 'a-strong-default-secret-key-for-development')
AI_CONTROLLER_WS_URL = os.getenv('AI_CONTROLLER_WS_URL', 'ws://ai-controller:8092')
AI_CONTROLLER_CONTROL_URL = os.getenv('AI_CONTROLLER_CONTROL_URL', 'http://ai-controller:8000/control/smart-thermostat-01')
...
class DashboardService:
    def __init__(self):
        ...
        self.ai_controller_ws_url = AI_CONTROLLER_WS_URL
        self.active_alerts = []
...
if __name__ == '__main__':
    ...
    socketio.run(app, host=APP_HOST, port=APP_PORT, debug=DEBUG_MODE)
